...
namespace Caffeine.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CaffeineLog>()
                .HasIndex(l => new { l.UserId, l.ConsumedAt });

            modelBuilder.Entity<FavoriteDrink>()
                .HasIndex(f => new { f.UserId, f.BeverageId, f.AmountMl })
                .IsUnique();

            modelBuilder.Entity<FavoriteDrink>()
                .HasOne(f => f.Beverage)
                .WithMany()
                .HasForeignKey(f => f.BeverageId)
            ...
            modelBuilder.Entity<Beverage>().HasData(
                ...
                new Beverage { Id = 4, Name = "Monster Ultra (Fehér/Zero)", Category = "Energy Drink", CaffeinePer100Ml = 32, DefaultPortionMl = 500 },
                ...
                new Beverage { Id = 25, Name = "Dolce Gusto (Espresso kapszula)", Category = "Capsule", CaffeinePer100Ml = 200, DefaultPortionMl = 40 },
                ...
                new Beverage { Id = 36, Name = "Dolce Gusto (Iced Frappé)", Category = "Capsule", CaffeinePer100Ml = 53.3, DefaultPortionMl = 150 },
                new Beverage { Id = 37, Name = "Dolce Gusto (Flat White)", Category = "Capsule", CaffeinePer100Ml = 55.5, DefaultPortionMl = 180 },
                new Beverage { Id = 38, Name = "Dolce Gusto (Starbucks Caramel Macchiato)", Category = "Capsule", CaffeinePer100Ml = 40, DefaultPortionMl = 200 }
            );
